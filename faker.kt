...
class Faker {
    companion object {
        ...
        fun anyConsumerRecord(withTopic: String? = null, withValue: String? = null): ConsumerRecord<String, String> {
            return ConsumerRecord(
                withTopic ?: Faker.anyTopicName(),
                this.anyIntPositive(),
                anyIntPositive().toLong(),
                this.anyWord(),
                withValue ?: this.anyWord()
            )
        }
    }
}